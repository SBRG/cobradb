...
#     file = open(settings.metacyc_dir +file_name,'r')
#     atts = []
#     attflag = 0
...
#     session = base.Session()
#     kegg_pathways = open(settings.kegg_pathways ,'r')
...
#     session = base.Session()
#     regulatory_network = open(settings.regulondb_data, 'r')
...
#     with open(settings.refseq_directory + '/' + chromosome.ncbi_id+'.gff', 'wb') as gff_file:
